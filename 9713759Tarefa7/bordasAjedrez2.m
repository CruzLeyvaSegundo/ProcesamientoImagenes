...
r1_bodeVertical=myImageFilter(r1_filtro,h);
...
r1_bodeHorizontal=myImageFilter(r2_filtro,v);
...
r3=myImageFilter(r3_bodeHorizontal,h);

%Obtencion de 1 linea roja vertical
gauss=fspecial('gaussian',[5 5],0.67);
r4_filtro=myImageFilter(img_double,gauss);
r4_bodeVertical=edge(r4_filtro,'canny');
r4=myImageFilter(r4_bodeVertical,v);
